...
public class BatchConfig {
  ...
  public final String[] FEILD_NAME = new String[] { "id", "city", "date", "player_of_match", "venue", "neutral_venue",
  ...
  public FlatFileItemReader<MatchInput> reader() {
    return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReader")
        .resource(new ClassPathResource("matchData.csv")).delimited().names(FEILD_NAME)
  ...
  // we wanna know when the job gets done
  @Bean
